...
export const alt = "Kalenderwochen im Jahr nach ISO 8601 – Kalender365.pro";
...
export default async function Image({ params }: { params: Promise<{ year: string }> }) {
  ...
  return renderOgImage({
    kicker: "Kalenderwochen",
    title: `Kalenderwochen ${y}`,
    subtitle: "Alle KW mit Datum nach ISO 8601",
  });
}
