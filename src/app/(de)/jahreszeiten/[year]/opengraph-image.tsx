...
export const alt = "Jahreszeiten – Frühlings-, Sommer-, Herbst- und Winteranfang – Kalender365.pro";
...
export default async function Image({ params }: { params: Promise<{ year: string }> }) {
  ...
  return renderOgImage({
    kicker: "Jahreszeiten",
    title: `Jahreszeiten ${y}`,
    subtitle: "Frühling, Sommer, Herbst & Winter – Anfangstermine",
  });
}
